                     ...
                     <form id="editTemplateForm" class="space-y-6">
                        ...
                        <div class="border-t border-gray-100 pt-6">
                            <div class="flex items-center justify-between mb-4">
                                ...
                                <div id="totalPeriodsDisplay" class="text-sm font-bold px-4 py-1.5 rounded-full bg-gray-100 text-gray-600 border border-gray-200 shadow-sm transition-all duration-300">
                                    Total: 0%
                                </div>
                            </div>
...
<script>
    ...
    function renderPeriods(periods) {
            ...
            html += `
                <div>
                    ...
                    <div class="relative mt-1 rounded-md shadow-sm">
                        <input type="number" step="0.01" data-period="${key}" value="${value}" oninput="calculatePeriodsTotal()" class="period-input block w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm px-4 py-2.5 border pr-8 shadow-sm">
        ...
        calculatePeriodsTotal();
    }

    function calculatePeriodsTotal() {
        ...
        const display = document.getElementById('totalPeriodsDisplay');
